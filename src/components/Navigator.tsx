    ...
    <div className="absolute bottom-10 h-20 w-full flex items-center justify-left">
      ...
      >
        ...
        <div className="flex gap-2  text-black text-[19px] font-extrabold ">
          <button
            className={`h-10 w-10 bg-[${buttonColor}] arrow-button arrow-button-left rounded-[50%] flex items-center justify-center cursor-pointer ${
          ...
          <button
            className={`h-10 w-10 bg-[${buttonColor}] arrow-button rounded-[50%] flex items-center justify-center cursor-pointer ${
              buttonColor === "white" ? "button-white" : ""
            }`}
            onClick={nextImg}
          >
